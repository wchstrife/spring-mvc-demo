    ...
    <form:form commandName="book" action="/book_update" method="post">
        <fieldset>
            ...
            <p>
                ...
                <form:select path="category.id" id="category"  items="${categpories}" itemLabel="name" itemValue="id"></form:select>
            </p>
            <p>
            ...
            <p id="buttons">
                ...
                <input id="sumbit" type="submit" tabindex="5" value="Update a book">
            </p>
        </fieldset>
    </form:form>
</div>
